...
This script sets the job name to "my_first_job", requests a walltime of 10 minutes, and then executes the command `echo "Hello, world!"`.
...
*   `#SBATCH --job-name=my_simulation`: Sets the job name to "my_simulation".
